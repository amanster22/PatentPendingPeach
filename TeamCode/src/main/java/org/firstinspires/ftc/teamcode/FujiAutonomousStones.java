...
public class FujiAutonomousStones extends FujiAutonomous {
    ...
    public final void runOpMode() {
        ...
        robot.EncoderMove(0.5 * StoneLength, 0, 0);
        current = 1;
        ...
        if (output) {
            ...
            robot.EncoderMove(StoneLength, 0, 0);
            current = 2;
        ...
        robot.EncoderMove(((skystone1 - 1) * StoneLength - Robot_Edge_Length) - (0.5 + (current - 1) * StoneLength), 0, 0); //final minus initial
        robot.GryoTurnTo(0.25);
        robot.EncoderMove(-10, 0, 0);
        robot.EncoderMove(0, 0.5 * StoneLength, 0);
        robot.EncoderMove(10, 0, 0);
